import { FacebookLogo, TwitterLogo, LinkedinLogo } from "@/components/Common/Icons";
    ...
    return (
        <div className="my-auto px-1 grid grid-cols-3 gap-4 w-[fit-content]">
            <div>
                <a
                    target="_blank"
                    href={`https://twitter.com/intent/tweet?url=https%3A%2F%2Fprototypr.io%2F${postType}%2F${slug}%2F&via=prototypr&text=Recommended%20read:%20%22${titleUrl}%22${authorTwitter ? "%20by%20" + authorTwitter : ""
    ...
    return (
        <div className="my-auto px-1 grid grid-cols-1 gap-4 w-[fit-content]">
            <div className="text-gray-500 hover:text-black">
                <a
                    target="_blank"
                    href={`https://twitter.com/intent/tweet?url=https%3A%2F%2Fprototypr.io%2Ftoolbox%2F${slug}%2F&via=prototypr&text=Check%20it%20out%20%22${titleUrl}%22${authorTwitter ? "%20by%20" + authorTwitter : ""
